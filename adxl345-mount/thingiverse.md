Mount for the ADXL345 accelerometer: attach to a ribbon cable strain relief with two M3 bolts (I used M3x20, will probably replace them with shorter ones at some point).
